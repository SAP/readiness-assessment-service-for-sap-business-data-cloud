...
SELECT
       DISTINCT(C.GROUP_NAME) as OBJECT_TAB, CASE WHEN UPPER(C.TLOGO) = 'NHUB' then REPLACE(C.GROUP_NAME,'/BIC/OH','') ELSE C.GROUP_NAME END OBJECT_NAME,
...
group by C.GROUP_NAME ,C.TLOGO,C.GROUP_TYPE
