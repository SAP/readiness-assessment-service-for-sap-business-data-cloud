...
union
select 'CBEX' as TLOGO, CAST(count(*) as varchar(20)), '', '', '', '', '', '', '' from <SID>.<OWNER_SCHEMA>.RSDDSTAT_OLAP where EVENTID = '3200' and STEPTP = 'BEX'
union
select 'CBRD' as TLOGO, CAST(count(*) as varchar(20)), '', '', '', '', '', '', '' from <SID>.<OWNER_SCHEMA>.RSDDSTAT_OLAP where EVENTID = '14601' OR EVENTID = '14611' OR EVENTID = '14671'
