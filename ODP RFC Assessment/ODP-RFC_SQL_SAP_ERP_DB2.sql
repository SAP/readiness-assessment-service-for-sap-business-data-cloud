-- ODP-RFC SQL -- SAP ERP 6.0 -- DB2
SELECT
    (SELECT CURRENT SERVER FROM SYSIBM.SYSDUMMY1)                   AS SID,
    ...
    0                                                               AS total_size_mb,
    ''                                                              AS SOURCE_OBJECT_DDL_NAME,
    LEFT(CHAR(MAX(aud.pointer)), 8)                                 AS LAST_EXECUTED_DATE,
    LEFT(CHAR(MIN(aud.pointer)), 8)                                 AS FIRST_EXECUTED_DATE
